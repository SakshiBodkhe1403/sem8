...
int main() {
    ...
    cout << "Sequential Elapsed time for Max in microseconds: " 
    << chrono::duration_cast<chrono::microseconds>(endSeq - startSeq).count() << " microsecs" << endl;

    startSeq = chrono::steady_clock::now();
    cout << "Sequential Sum = " << calculateSumSequential(arr, n) << endl;
    endSeq = chrono::steady_clock::now();
    cout << "Sequential Elapsed time for Sum in microseconds: " 
    << chrono::duration_cast<chrono::microseconds>(endSeq - startSeq).count() << " microsecs" << endl;

    startSeq = chrono::steady_clock::now();
    cout << "Sequential Average = " << calculateAverageSequential(arr, n) << endl;
    endSeq = chrono::steady_clock::now();
    cout << "Sequential Elapsed time for Average in microseconds: "
     << chrono::duration_cast<chrono::microseconds>(endSeq - startSeq).count() << " microsecs" << endl;
    ...
    cout << "Parallel Elapsed time for Min in microseconds: " 
    << chrono::duration_cast<chrono::microseconds>(endParallel - startParallel).count() << " microsecs" << endl;

    startParallel = chrono::steady_clock::now();
    cout << "Parallel Max = " << findMaxParallel(arr, n) << endl;
    endParallel = chrono::steady_clock::now();
    cout << "Parallel Elapsed time for Max in microseconds: " 
    << chrono::duration_cast<chrono::microseconds>(endParallel - startParallel).count() << " microsecs" << endl;

    startParallel = chrono::steady_clock::now();
    cout << "Parallel Sum = " << calculateSumParallel(arr, n) << endl;
    endParallel = chrono::steady_clock::now();
    cout << "Parallel Elapsed time for Sum in microseconds: " 
    << chrono::duration_cast<chrono::microseconds>(endParallel - startParallel).count() << " microsecs" << endl;

    startParallel = chrono::steady_clock::now();
    cout << "Parallel Average = " << calculateAverageParallel(arr, n) << endl;
    endParallel = chrono::steady_clock::now();
    cout << "Parallel Elapsed time for Average in microseconds: " 
    << chrono::duration_cast<chrono::microseconds>(endParallel - startParallel).count() << " microsecs" << endl;
